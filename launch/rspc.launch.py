...
launch_args = [
    ...
    DeclareLaunchArgument(
        name="publish_tf",
        default_value="false",
        description="if true, launch file runs a joint state publisher for the cameras",
    ),
]
...
def generate_launch_description():
    opfunc = OpaqueFunction(
        function=launch_setup, kwargs={"params": set_configurable_parameters(configurable_parameters)}
    )
